...
class LightningGemActive : Actor {
	...
	states {
		Spawn:  
			...
			TNT1 A 0 A_SpawnProjectile("LitBolt", 0, 0, random(0,360), CMF_AIMDIRECTION);
			TNT1 A 0 A_SpawnProjectile("LitBoltChase", 0, 0, random(0,360), CMF_AIMDIRECTION);
			LGEM A 2;
			TNT1 AA 0 A_SpawnItemEx("GemLightningBoltSpawner",random(-120,120),random(-120,120),150);
			TNT1 A 0 A_SpawnProjectile("LitBolt", 0, 0, random(0,360), CMF_AIMDIRECTION);
			TNT1 A 0 A_SpawnProjectile("LitBoltChase", 0, 0, random(0,360), CMF_AIMDIRECTION);
			...
			TNT1 AA 0 A_SpawnItemEx("GemLightningBoltSpawner",random(-120,120),random(-120,120),150);
			TNT1 A 0 A_SpawnProjectile("LitBolt", 0, 0, random(0,360), CMF_AIMDIRECTION);
			TNT1 A 0 A_SpawnProjectile("LitBoltChaseEx", 0, 0, random(0,360), CMF_AIMDIRECTION);
			LGEM A 2;
			TNT1 AA 0 A_SpawnItemEx("GemLightningBoltSpawner",random(-120,120),random(-120,120),150);
			TNT1 A 0 A_SpawnProjectile("LitBolt", 0, 0, random(0,360), CMF_AIMDIRECTION);
			TNT1 A 0 A_SpawnProjectile("LitBolt", 0, 0, random(0,360), CMF_AIMDIRECTION);
