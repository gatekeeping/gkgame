...
class PoisonGemActive : Actor {
	...
	states {
		Spawn:  
			...
			TNT1 AAA 0 A_SpawnProjectile("GemPoisonMist", random(-2,4), 0, random(0,360), CMF_AIMDIRECTION);
			TNT1 AA 0 A_SpawnProjectile("GemPoisonCloud", random(0,4), 0, random(0,360), CMF_AIMDIRECTION);
			POGM A 4;
			TNT1 A 0 A_PlaySound("gem/poison/puff");
			TNT1 AAA 0 A_SpawnProjectile("GemPoisonMist", random(-2,4), 0, random(0,360), CMF_AIMDIRECTION);
			TNT1 AA 0 A_SpawnProjectile("GemPoisonCloud", random(0,4), 0, random(0,360), CMF_AIMDIRECTION);
...
class GemPoisonCloud : Actor {
	...
	states {
		...
		Death:
			...
			TNT1 A 0 A_SpawnProjectile("GemPoisonBubble",0,0,random(0,360),CMF_AIMDIRECTION,random(-2,7));
